...
const variantClasses: Record<Variant, string> = {
  primary: "bg-highlight text-accent-foreground hover:bg-highlight/85 active:bg-highlight/75",
  secondary: "border border-border text-foreground hover:bg-muted hover:border-border-strong",
