...
export function Card({ className, ...rest }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn("border border-border", className)} {...rest} />
  );
}
...
export function CardTitle({ className, ...rest }: HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h2
      className={cn("font-display-text text-base font-semibold leading-none text-foreground", className)}
      {...rest}
    />
  );
}
...
export function CardDescription({
  ...
  return (
    <p className={cn("text-sm font-light text-muted-foreground leading-relaxed", className)} {...rest} />
  );
}
