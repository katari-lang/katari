...
export function Card({ className, ...rest }: HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("border border-border flex flex-col", className)} {...rest} />;
}
...
export function CardDescription({ className, ...rest }: HTMLAttributes<HTMLParagraphElement>) {
  return (
    <p
      className={cn("text-sm font-light text-muted-foreground leading-relaxed", className)}
      {...rest}
    />
  );
}
