 ...
 * chained result keeps its types for the RPC client. Project / snapshot are live; run / escalation /
 * file / env / agent freeze their contracts and return 501 until the engine and stores land.
 */
