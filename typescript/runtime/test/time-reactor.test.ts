...
function timeIr(): IRModule {
  ...
  return {
    ...
    entries: {
      [createAgentName("now_main")]: { block: 0, private: false },
      [createAgentName("sleep_main")]: { block: 2, private: false },
      [createAgentName("watch_main")]: { block: 4, private: false },
      [createAgentName("watch_fail_main")]: { block: 6, private: false },
      [createAgentName("tick_agent")]: { block: 8, private: false },
      [createAgentName("boom_agent")]: { block: 10, private: false },
      [createAgentName("prelude.time.now")]: { block: 12, private: false },
      [createAgentName("prelude.time.sleep")]: { block: 14, private: false },
      [createAgentName("prelude.time.watch")]: { block: 16, private: false },
      [createAgentName("record_tick")]: { block: 18, private: false },
      [createAgentName("boom")]: { block: 20, private: false },
    },
    names: {},
  };
}
