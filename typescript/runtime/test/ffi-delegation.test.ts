...
function ir(): IRModule {
  return {
    ...
    entries: {
      ...
      [createAgentName("prelude.add")]: { block: 10, private: false },
      [createAgentName("ask_value")]: { block: 15, private: false },
      [createAgentName("typed_compute")]: { block: 20, private: false },
      [createAgentName("typed_main")]: { block: 25, private: false },
      [createAgentName("strict")]: { block: 30, private: false },
    },
    names: {},
  };
}
