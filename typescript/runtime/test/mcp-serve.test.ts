...
const SERVE_IR: IRModule = {
  ...
  entries: {
    ...
    [createAgentName("wrap")]: { block: 4, private: false },
    [createAgentName("boom")]: { block: 6, private: false },
    [createAgentName("secret_reply")]: { block: 8, private: false },
    [createAgentName("prelude.mcp.serve")]: { block: 10, private: false },
    [createAgentName("subscriber")]: { block: 12, private: false },
    [createAgentName("wait")]: { block: 14, private: false },
    [createAgentName("prelude.throw")]: { block: 16, private: false },
    [createAgentName("prelude.secret")]: { block: 18, private: false },
  },
  names: {},
};
...
describe("the mcp reactor (serve, restart survival)", () => {
  test("the endpoint outlives a restart: token + tools reload and re-register", async () => {
    ...
    // the tools record reload from the extension's `serve` variant; nothing is re-dispatched.
